...
docs = json.load(open('../data/news_sohusite_labeled.json'))
# docs = json.load(open('../data/news_sohusite_labeled.smarty.json'))
...
def produce_docs(docs):
    ...
    f1 = open('../data/train_contents_unsplit.txt','w')
    f2 = open('../data/train_labels.txt','w')
    f3 = open('../data/test_contents_unsplit.txt','w')
    f4 = open('../data/test_labels.txt','w')
    f1.write('\n'.join(train_contents))
    f2.write('\n'.join(train_labels))
    f3.write('\n'.join(test_contents))
    f4.write('\n'.join(test_labels))
